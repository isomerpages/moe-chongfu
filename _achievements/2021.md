...
.tg th{border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;
  font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg .tg-k2px{background-color:#FFF;border-color:inherit;color:#808080;text-align:left;vertical-align:middle}
.tg .tg-w1zq{background-color:#FFF;border-color:inherit;color:#808080;font-weight:bold;text-align:left;vertical-align:top}
</style>
<table class="tg">
<thead>
  <tr>
    <th class="tg-w1zq"><span style="font-weight:bold">CCA</span></th>
    <th class="tg-w1zq"><span style="font-weight:bold">ACHIEVEMENT</span></th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-w1zq"><span style="font-weight:bold">5 April 2021</span><br><span style="font-weight:bold">SYF 2021 Art Exhibition</span> :<br><span style="font-weight:bold">National Competition</span><br><br>Certificate of Recognition</td>
    <td class="tg-k2px">WEI MIN EN, SHANNON (6 Inn)<br>YEE XIN YIN (YU XINYIN) (6 Uni)<br>PUTERI NUR ADRIANNI BINTE NOR EFFENDY (6 Uni)<br>KOH MUN TONG JOSHUA (6 Sin)<br>ADITI GANESH RAO (4 Ach)<br>NUR SAKIINAH BINTI FAUZI (4 Inn)<br>ONG YAN HUI KELLY (4 Ach)<br>RAEANNE SOH YI XIN (4 Inn)<br>TAN SI JIA (4 Ach)<br>TAN YING XUAN VELLA (4 Car)<br>WEI LI WILLIAM (4 Gra)<br>YU ZHIYI (4 Obs)</td>
  </tr>
</tbody>
</table></p>  
    </div>  
